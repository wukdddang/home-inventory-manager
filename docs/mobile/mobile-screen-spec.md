...
- [ ] 권한 거부 시 안내 토스트
- [ ] Mock 단계: `console.log`로 토큰 등록 대체
...
**체크리스트:**
- [ ] 재고 카드 그리드 `grid-cols-1 md:grid-cols-2` 적용
- [ ] 바텀시트 태블릿 `max-w-md mx-auto` 적용
- [ ] 이력 카드 태블릿 폭 조정
...
**체크리스트:**
- [ ] 모든 버튼/탭 터치 타겟 44×44px 이상 확인
- [ ] input 요소 `font-size: 16px` (iOS 줌 방지)
- [ ] `safe-area-inset-bottom` 하단 탭에 적용
- [ ] `100dvh` 사용 확인
- [ ] 빈 상태 UI 구현 (재고 없음 / 이력 없음)
- [ ] 스켈레톤 로딩 상태 구현
