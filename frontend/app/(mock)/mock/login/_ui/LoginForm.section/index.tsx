        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1.5 w-full rounded-xl border border-zinc-700 bg-zinc-900 px-3 py-2.5 text-sm text-white outline-none ring-teal-500/40 placeholder:text-zinc-600 focus:border-teal-500 focus:ring-2"
