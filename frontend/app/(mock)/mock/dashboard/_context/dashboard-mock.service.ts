...
export const MOCK_SEED_HOUSEHOLDS: Household[] = [
  {
    ...
    furniturePlacements: [
      {
        id: "fp-mock-kitchen-wall",
        roomId: "mock-room-kitchen",
        label: "벽면장",
        sortOrder: 0,
      },
      {
        id: "fp-mock-kitchen-fridge",
        roomId: "mock-room-kitchen",
        label: "냉장고",
        sortOrder: 1,
      },
      ...
      {
        id: "fp-mock-storage-rack",
        roomId: "mock-room-storage",
        label: "선반",
        sortOrder: 0,
      },
      {
        id: "fp-mock-living-tv",
    ...
    storageLocations: [
      {
        ...
        name: "벽면장 기본",
        roomId: null,
        furniturePlacementId: "fp-mock-kitchen-wall",
        sortOrder: 0,
      },
      {
        ...
        name: "냉장실",
        roomId: null,
        furniturePlacementId: "fp-mock-kitchen-fridge",
        sortOrder: 0,
      },
      {
        id: "sl-mock-kitchen-fridge-freezer",
        name: "냉동실",
        roomId: null,
        furniturePlacementId: "fp-mock-kitchen-fridge",
        sortOrder: 1,
      ...
      },
      {
        ...
        name: "선반 기본",
        roomId: null,
        furniturePlacementId: "fp-mock-storage-rack",
        sortOrder: 0,
      },
      {
        ...
        name: "서랍",
        roomId: null,
        furniturePlacementId: "fp-mock-living-tv",
        sortOrder: 0,
      },
      /* v2.8: 가전 하위 보관 장소 */
      {
        id: "sl-mock-appliance-washer-filter",
        name: "필터함",
        roomId: null,
      ...
      {
        id: "sl-mock-appliance-airpurifier-filter",
        name: "필터 슬롯",
        roomId: null,
        furniturePlacementId: null,
