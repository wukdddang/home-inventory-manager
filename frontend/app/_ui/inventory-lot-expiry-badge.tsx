...
export function InventoryLotExpiryBadge({
  ...
  if (worstExpiryDays < 0) {
    return (
      <span
        className={cn(
          "rounded-full bg-rose-500/20 px-2 py-0.5 text-[10px] font-medium text-rose-200 ring-1 ring-rose-500/40",
          className,
        )}
      >
  ...
  if (worstExpiryDays === 0) {
    return (
      <span
        className={cn(
          "rounded-full bg-amber-500/20 px-2 py-0.5 text-[10px] font-medium text-amber-100 ring-1 ring-amber-500/35",
          className,
        )}
      >
        오늘만료 · {lotCount}로트
  ...
  if (worstExpiryDays <= 3) {
    return (
      <span
        className={cn(
          "rounded-full bg-amber-500/15 px-2 py-0.5 text-[10px] font-medium text-amber-100 ring-1 ring-amber-500/30",
          className,
        )}
      >
